...
# 输入的两个 TIFF 文件路径
tiff_file1 = 'cropped_data/result/cropped_cmip6_rf.tif'  # 替换为你的第一个 TIFF 文件路径
tiff_file2 = 'cropped_data/result/cropped_predicted_rf.tif'  # 替换为你的第二个 TIFF 文件路径
output_file = 'cropped_data/result/sub_rf.tif'  # 替换为输出文件路径
